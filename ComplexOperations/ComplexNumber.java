...
// double, it needs to subtract parameters from fields, in other words, it needs
// to do a complex number subtract operation as described above.
...
// * Method named getReal without any parameters, it needs to return the value
// of real field.
// * Method named getImaginary without any parameters, it needs to return the
