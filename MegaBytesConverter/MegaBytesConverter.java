...
// * printMegaBytesAndKiloBytes(2500); → should print the following text: "2500
// KB = 2 MB and 452 KB"

// * printMegaBytesAndKiloBytes(-1024); → should print the following text:
// "Invalid Value" because parameter is less than 0.

// * printMegaBytesAndKiloBytes(5000); → should print the following text: "5000
// KB = 4 MB and 904 KB"
...
// NOTE: The printMegaBytesAndKiloBytes method needs to be defined as public
